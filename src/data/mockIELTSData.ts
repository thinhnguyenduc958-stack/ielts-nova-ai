...
export const systemIELTSVocabulary: VocabularyItem[] = [
  ...
  },
  {
    id: 'vocab-4',
    word: 'ubiquitous',
    meaning: 'phổ biến khắp nơi, có mặt ở mọi nơi',
    contextMeaning: 'Hiện diện ở mọi phương diện đời sống số',
    partOfSpeech: 'adjective',
    ipa: '/juːˈbɪk.wɪ.təs/',
    exampleSentence: 'Smartphones have become ubiquitous fixtures in contemporary social interactions.',
    ...
    ieltsRelevance: 'Band 7.5+ Technology & Society Essays',
    difficulty: 'advanced',
    status: 'mastered',
...
export const sampleReadingPassages: ReadingPassage[] = [
  {
    id: 'read-01',
    title: 'Biophilic Architecture & The Vertical Forest Revolution',
...
Nevertheless, detractors emphasize the prohibitive capital expenditures required to install and perpetually maintain sophisticated automated hydration conduits at high altitudes. Structural calculations must account for intense wind shear and substantial soil moisture mass under storm conditions. Unless municipal governments formulate targeted fiscal subsidies, widespread adoption may remain confined to affluent enclaves.`,
    ...
    questions: [
      ...
      },
      {
        id: 'rq-3',
        type: 'true-false-notgiven',
        prompt: 'Vertical forests in Milan are fully funded by national government subsidies.',
        options: ['TRUE', 'FALSE', 'NOT GIVEN'],
        correctAnswer: 'NOT GIVEN',
        explanation: 'The passage mentions that municipal subsidies are recommended in Paragraph D, but never provides details about the exact funding sources of the Milan project.',
        paragraphRef: 'p-4',
      },
      {
        id: 'rq-4',
...
export const sampleSpeakingQuestions = [
  ...
  },
  {
    id: 'spk-part2',
    part: 2,
    topic: 'An Unforgettable Learning Experience',
    cueCard: {
      topic: 'Describe an educational subject or skill you found challenging initially but eventually mastered.',
      bulletPoints: [
        'What the subject or skill was',
        'Why you decided to undertake it',
        'What obstacles or frustrations you encountered',
        'And explain how you felt once you achieved proficiency.',
      ],
      prepTimeSeconds: 60,
